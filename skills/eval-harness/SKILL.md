...
grep -q "func handleAuth" Sources/Services/auth.swift && echo "PASS" || echo "FAIL"

# Check if tests pass
swift test && echo "PASS" || echo "FAIL"

# Check if build succeeds
swift build && echo "PASS" || echo "FAIL"
```
